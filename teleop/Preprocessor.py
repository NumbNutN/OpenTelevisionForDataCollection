...
class VuerPreprocessor:
    ...
    def process_fixed(self, tv):
       ...
       # homogeneous
        ...
        rel_left_fingers = (hand2inspire.T @ left_fingers)[0:3, :].T
        rel_right_fingers = (hand2inspire.T @ right_fingers)[0:3, :].T

        return head_mat, left_wrist_mat, right_wrist_mat, rel_left_fingers, rel_right_fingers
