...
class Saver:
    ...
    def __init__(self, filename, times):
        ...
        self.file.create_dataset(head_pose, (times, 7), dtype='f')
    ...
    def save(self, head_pose, left_pose, right_pose):
        ...
        self.file[head_pose][(self.times - self.remain_times)] = head_pose
...
class Loader:
    ...
    def __init__(self, filename):
        ...
        self.times = self.file[head_pose].shape[0]
        self.index = 0
    ...
    def load(self):
        ...
        head_pose = self.file[head_pose][self.index]
        ...
        self.index += 1
        return time_stamp, head_pose, left_pose, right_pose